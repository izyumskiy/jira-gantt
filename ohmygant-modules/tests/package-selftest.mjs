...
const historicalIssue = {
  key: "AO-100", summary: "Backend API", assignee: { username: "ivan", displayName: "Иванов Иван" },
...
const jiraSource = {
  type: "jira", key: "AO-200", title: "Backend API",
...
const forecast = await planning.run({
  project: "AO-200", people: [employee], teams: [team],
